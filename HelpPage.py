...
class HelpPage(Scene):
    ...
    def show(self, window):
        ...
        self.textRect = self.text.get_rect(center=(WindowSettings.width // 2, WindowSettings.height // 2))
        self.QuitRect = self.QuitButton.get_rect(center=(WindowSettings.width // 2, WindowSettings.height // 2 + 100))
