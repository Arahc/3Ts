    ...
    for enData in enemyDatas:
        ...
        if enData['type'] == 'normal':
            ...
            enemy = Character(
                ...
                img=Img(pg.image.load(enData['imgLocation'] + ".png").convert_alpha(), tuple(enData['imgSize']), picPos),
                imgDash=Img(pg.image.load(enData['imgLocation'] + "-dash.png").convert_alpha(), tuple(enData['imgDashSize']), picPos),
                imgAttackYang=Img(pg.image.load(enData['imgLocation'] + "-attack-yang.png").convert_alpha(), tuple(enData['imgAttackSize']), picPos),
                imgAttackYin=Img(pg.image.load(enData['imgLocation'] + "-attack-yin.png").convert_alpha(), tuple(enData['imgAttackSize']), picPos),
            )
        else:
            ...
            enemy = Character(
                ...
                SPHeal=enData['SPHeal'],
                cards=[loadCard(card) for card in enData['cards']],
                img=Img(pg.image.load(enData['imgLocation'] + ".png").convert_alpha(), tuple(enData['imgSize']), bossPos),
                imgDash=Img(pg.image.load(enData['imgLocation'] + ".png").convert_alpha(), tuple(enData['imgDashSize']), bossPos),
                imgAttackYang=Img(pg.image.load(enData['imgLocation'] + "-attack-yang.png").convert_alpha(), tuple(enData['imgAttackSize']), bossPos),
                imgAttackYin=Img(pg.image.load(enData['imgLocation'] + "-attack-yin.png").convert_alpha(), tuple(enData['imgAttackSize']), bossPos),
            )
